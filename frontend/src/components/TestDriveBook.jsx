...
function SelectInput({ value, onChange, disabled, error, highlight, children }) {
  return (
    <div style={{ position: "relative" }}>
      <select
        ...
        style={{
          ...
          background: highlight
            ...
            : error ? "rgba(239,68,68,0.04)" : "rgba(255,255,255,0.03)",
          border: `1px solid ${
            highlight
              ? "rgba(224,123,42,0.6)"
              : error ? "rgba(239,68,68,0.45)" : value ? "rgba(224,123,42,0.35)" : "rgba(255,255,255,0.08)"
          }`,
          color: value ? "#fff" : "#555",
          fontFamily: "'Rajdhani', sans-serif",
          fontSize: 14, fontWeight: 600,
      ...
      <svg
        style={{ position: "absolute", right: 12, top: "50%", transform: "translateY(-50%)", pointerEvents: "none", color: highlight ? "#e07b2a" : "#555" }}
...
function Badge({ badge }) {
  ...
  return (
    <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", padding: "2px 7px", border: "1px solid" }}
      className={`${cfg.bg} ${cfg.text} ${cfg.border}`}>
      {badge}
    </span>
  );
}

/* ─── PRESELECT FLASH LABEL ──────────────────────────────────────────────── */
function AutoFillBadge() {
  return (
    <span style={{
      display: "inline-flex", alignItems: "center", gap: 4,
      fontSize: 8, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase",
      color: "#e07b2a", background: "rgba(224,123,42,0.1)",
      border: "1px solid rgba(224,123,42,0.3)",
      padding: "2px 8px", marginLeft: 8,
      animation: "tdFadeUp 0.4s ease both",
    }}>
...
// ── Main Component ───────────────────────────────────────────────────────────
/**
 * @param {{ brand: string, model: string } | null} preselect
 *   When provided, auto-fills the brand and model dropdowns and scrolls into view.
 */
    ...
    return (
      <div style={wrap}>
        ...
        <div style={{
          ...
          animation: "tdSlideUp 0.35s cubic-bezier(0.16,1,0.3,1) both",
          display: "flex", flexDirection: "column", alignItems: "center",
          padding: "48px 28px 40px", textAlign: "center", gap: 14,
        }}>
          ...
          {particles.map(p => (
            <div key={p.id} style={{
              ...
              animation: `tdFloat ${p.duration} ${p.delay} ease-in-out infinite`,
              pointerEvents: "none",
            }} />
          ))}
          ...
          <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2.2rem", letterSpacing: "0.08em", color: "#fff", animation: "tdFadeUp 0.5s 0.05s both" }}>
            TEST DRIVE CONFIRMED
          </div>
          <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.2em", textTransform: "uppercase", color: "#555", animation: "tdFadeUp 0.5s 0.12s both" }}>
            Congratulations, your session is booked
          </div>

          {car && (
            <div style={{ animation: "tdFadeUp 0.5s 0.18s both" }}>
              <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.6rem", letterSpacing: "0.06em", color: "#e07b2a" }}>
                {car.brand} {car.model}
              </div>
          ...
          <p style={{ fontSize: 10, fontWeight: 600, letterSpacing: "0.15em", textTransform: "uppercase", color: "#333", animation: "tdFadeUp 0.5s 0.34s both" }}>
          ...
          <button
            ...
            style={{
              ...
              animation: "tdFadeUp 0.5s 0.48s both",
            }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = "rgba(224,123,42,0.35)"; e.currentTarget.style.color = "#e07b2a"; }}
  ...
  return (
    <div style={wrap}>
      ...
      <div style={{ width: "100%", maxWidth: 520, animation: "tdSlideUp 0.35s cubic-bezier(0.16,1,0.3,1) both" }}>
        <div style={{ background: "#0f0f0f", border: "1px solid rgba(255,255,255,0.08)", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ padding: "22px 24px 18px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
            ...
            {car ? (
              ...
              <h1 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(1.6rem,5vw,2.4rem)", letterSpacing: "0.06em", color: "rgba(255,255,255,0.12)", lineHeight: 1 }}>
                Select a Vehicle
              </h1>
            )}
          </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div>
                ...
                <SelectInput
                  value={form.brand}
                  error={errors.brand}
                  highlight={justAutoFilled && !!form.brand}
                  onChange={e => {
                    setForm(f => ({ ...f, brand: e.target.value, model: "" }));
                    setErrors(er => ({ ...er, brand: "", model: "" }));
                    setJustAutoFilled(false);
                  }}
                >
              ...
              <div>
                ...
                <SelectInput
                  value={form.model}
                  error={errors.model}
                  highlight={justAutoFilled && !!form.model}
                  onChange={set("model")}
                  disabled={!form.brand}
                >
          ...
          <div style={{ padding: "0 24px 24px" }}>
            ...
            <button
              ...
              onMouseEnter={e => {
                e.currentTarget.querySelector(".td-fill").style.transform = "translateX(0)";
                e.currentTarget.style.color = "#000";
                e.currentTarget.style.borderColor = "#e07b2a";
              }}
              onMouseLeave={e => {
                e.currentTarget.querySelector(".td-fill").style.transform = "translateX(-101%)";
            ...
            >
              ...
              <span style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
                ...
                <svg width="13" height="11" viewBox="0 0 13 11" fill="none">
                  <path d="M1 5.5H12M7.5 1L12 5.5L7.5 10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </span>
            </button>
          </div>
        ...
        <p style={{ textAlign: "center", fontSize: 9, fontWeight: 700, letterSpacing: "0.28em", textTransform: "uppercase", color: "#222", marginTop: 16 }}>
          AutoBharat · Test Drive Program
        </p>
      </div>
    </div>
  );
